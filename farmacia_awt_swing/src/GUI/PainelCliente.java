...
public class PainelCliente extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnSalvar) {
			Cliente c = new Cliente(textFieldNome.getText(), textFieldCPF.getText(), textFieldRG.getText(),
					textFieldEndereco.getText(), textFieldTelefone.getText());
			try {
				...
				JOptionPane.showMessageDialog(this, "Erro ao salvar o cliente!", TOOL_TIP_TEXT_KEY,
